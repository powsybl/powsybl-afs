...
public class CassandraDataSplit {
    ...
    public void test(CqlSession cassandraSession) throws IOException {

        CassandraTestContext cassandraTestContext = new CassandraTestContext(cassandraSession);
        ...
        ResultSet resultSet = cassandraSession.execute(selectFrom(NODE_DATA)
                .column(CHUNKS_COUNT)
